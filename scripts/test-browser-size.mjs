...
// extensionless/.js aliases. Exclude server runtimes (server, core, edge, node, testing,
...
const excludedPaths = [
  ...
  /^http\.js$/,
  // The production logger entry is for the server entry and re-exports a server helper.
  /^logger\.js$/,
